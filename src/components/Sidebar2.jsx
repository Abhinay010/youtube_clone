    ...
    <div className="px-6 w-[20%] h-[calc(100vh-6.625rem)] overflow-y-scroll overflow-x-hidden">
      ...
      <div className=" mt-3  items-center">
        {sidebarItems.map((item) => {
          return (
            <div key={item.id} className="flex items-center space-x-1 hover:bg-gray-300 duration-300 rounded-xl p-2 ">
      ...
      <div className="  items-center">
        <div className="flex items-center space-x-2 hover:bg-gray-300 duration-300 rounded-xl p-2 ">
